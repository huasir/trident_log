...
public class LoggerFactory {
    ...
    public static final String LOGBACK_PATH = "resources/logback.xml";
    ...
    public static LoggerContext initLogContent(String tn) throws JoranException {
        LoggerContext context = (LoggerContext) org.slf4j.LoggerFactory.getILoggerFactory();
        String topologyName = context.getProperty(Konsts.TOPOLOGY_NAME_STR);
        if (topologyName == null || topologyName.equals("") || !topologyName.equals(tn)) {
            JoranConfigurator configurator = new JoranConfigurator();
            configurator.setContext(context);
            context.putProperty(Konsts.TOPOLOGY_NAME_STR, tn);
            configurator.doConfigure(ClassLoader.getSystemResourceAsStream(LOGBACK_PATH));
        }
        return context;
    }

    public static Logger getLogger(String name, String topologyName) throws JoranException {
        return initLogContent(topologyName).getLogger(name);
    }

    public static Logger getLogger(Class clazz, String topologyName) {
        try {
            return getLogger(clazz.getName(), topologyName);
